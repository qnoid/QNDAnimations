Pod::Spec.new do |s|
  ...
  s.version      = "2.0"
  s.summary      = "An API that introduces the idea of 'rewinding', 'toggling' and 'forwarding' in UIView animations."
  s.homepage     = "https://github.com/qnoid/QNDAnimations"
  s.license			 = "MIT"

  s.author       = { "Markos Charatzas" => "markos@qnoid.com" }
  s.source       = { :git => "https://github.com/qnoid/QNDAnimations.git", :tag => "2.0" }
  s.platform     = :ios, '5.0'
